...
# file.remove("results/calibration.snt/manholes.snt.no.cal1.csv")
# file.remove("results/calibration.snt/dwpee.snt.no.cal1.csv")
# file.remove("results/calibration.snt/dwpoo.snt.no.cal1.csv")
# file.remove("results/calibration.snt/dwshower.snt.no.cal1.csv")
# file.remove("results/calibration.snt/dwkitchensink.snt.no.cal1.csv")
# file.remove("results/calibration.snt/dwwmachine.snt.no.cal1.csv")
# file.remove("results/calibration.snt/dwwashbasin.snt.no.cal1.csv")
# 
# file.create("results/calibration.snt/manholes.snt.no.cal1.csv")
# file.create("results/calibration.snt/dwpee.snt.no.cal1.csv")
# file.create("results/calibration.snt/dwpoo.snt.no.cal1.csv")
# file.create("results/calibration.snt/dwshower.snt.no.cal1.csv")
# file.create("results/calibration.snt/dwkitchensink.snt.no.cal1.csv")
# file.create("results/calibration.snt/dwwmachine.snt.no.cal1.csv")
# file.create("results/calibration.snt/dwwashbasin.snt.no.cal1.csv")


#Load SMS-ABM Netlogo outcomes ----
manholes.snt <- read_csv(
  "results/calibration.snt/manholes.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","manhole.id","wwp.id","seed","run","exp"))

pee.snt <- read_csv(
  "results/calibration.snt/dwpee.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","CVEGEO","wwp.id","seed","run","exp"))

poo.snt <- read_csv(
  "results/calibration.snt/dwpoo.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","CVEGEO","wwp.id","seed","run","exp"))

kitchen.snt <- read_csv(
  "results/calibration.snt/dwkitchensink.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","CVEGEO","wwp.id","seed","run","exp"))

shower.snt <- read_csv(
  "results/calibration.snt/dwshower.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","CVEGEO","wwp.id","seed","run","exp"))

washingmachine.snt <- read_csv(
  "results/calibration.snt/dwwmachine.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","CVEGEO","wwp.id","seed","run","exp"))

washbasin.snt <- read_csv(
  "results/calibration.snt/dwwashbasin.snt.no.cal1.csv",
  col_names = c(
    "ind.id","date.time","day.n","event.typ","CVEGEO","wwp.id","seed","run","exp"))
...
write_csv(mh.out.06min.snt.df,'results/calibration.snt/no.cal.mh.out.06min.snt.df.csv')
write_csv(mh.out.12min.snt.df,'results/calibration.snt/no.cal.mh.out.12min.snt.df.csv')
write_csv(mh.out.30min.snt.df,'results/calibration.snt/no.cal.mh.out.30min.snt.df.csv')
write_csv(mh.out.60min.snt.df,'results/calibration.snt/no.cal.mh.out.60min.snt.df.csv')
write_csv(mh.out.180min.snt.df,'results/calibration.snt/no.cal.mh.out.180min.snt.df.csv')
...
#source("code/dw.abm.validation.snt.no.cal.R")
