...
to setup
  ...
  time:anchor-schedule time:create "2000-01-01 12:00" 0.5 "hour"
  set current-time time:anchor-to-ticks time:create "2000-01-01 12:00" 10 "minute"
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   time:schedule-event turtles [ [] -> go-forward ] time:create "2000-01-2 12:00"
   ...
   time:schedule-event-shuffled turtles [ [] -> go-forward ] time:create "2000-01-2 12:00"
  ...
  ;; to reschedule the event immediately after it has been performed)
   ...
   time:schedule-repeating-event-with-period (one-of turtles) ([ [] -> go-forward ]) 3.25 2.0 "minute"

  ; the number of ticks does not correspond to the number of days
  ;; See what's on your schedule
   print time:show-schedule
   print time:show current-time "EEEE, MMMM d, yyyy, HH:mm"
   ;print time:show show-schedule "EEEE, MMMM d, yyyy, HH:mm"
