...
to setup
  ...
  time:anchor-schedule time:create "2000-01-01 12:00" 1 "hour"
  set current-time time:anchor-to-ticks time:create "2000-01-01 12:00" 1 "hour"
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   ;time:schedule-event turtles [ [] -> go-forward ] time:create "2000-01-01 16:00"
  ...
  ;; to reschedule the event immediately after it has been performed)
   ...
   time:schedule-repeating-event-with-period (one-of turtles) ([ [] -> go-forward ]) 3.25 2.0 "hour"
...
to go-forward
  ...
  if turtles-reschedule-themselves [
    time:schedule-event self [ [] -> go-forward ] ticks + 1
  ]
end
